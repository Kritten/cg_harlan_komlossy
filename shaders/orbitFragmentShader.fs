...
{    
    ...
    float sun_part = distance_func(sun_location.xyz, passed_vs_position, 5.0f) * sun_inten;
    float light_part = distance_func(light_location.xyz, passed_vs_position, 0.5f) * light_inten;
